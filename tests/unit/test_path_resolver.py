...
class TestPathResolver:
    ...
    def test_path_resolver_should_find_from_upper_dir(self, request: FixtureRequest) -> None:
    ...
    def test_path_resolver_should_find_nearest_file(self, request: FixtureRequest) -> None:
    ...
    def test_path_resolver_should_raise_error_if_not_found(
        ...
        with pytest.raises(FileNotFoundError):
            resolve_relative_path(
                data_dir_path, request.config.rootpath, non_existing_path, Path(__file__), is_file=is_file
            )
