...
PATH_ENCODING_FILE_DIR = Path(PATH_TEXT_FILE_DIR, "encoding")
PATH_TEXT_FILE = PATH_TEXT_FILE_DIR / "text.txt"
PATH_LATIN1_TEXT_FILE = PATH_ENCODING_FILE_DIR / "latin-1.txt"
PATH_UTF16_TEXT_FILE = PATH_ENCODING_FILE_DIR / "utf-16.txt"
