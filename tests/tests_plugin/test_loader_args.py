...
from .helper import TestContext, is_valid_fixture_names, run_pytest_with_context

pytestmark = pytest.mark.plugin


class TestLoaderArgs:
    """Tests for loader argument validation."""
    ...
    def test_loader_with_valid_args(
        self, test_context: TestContext, fixture_names: str | tuple[str, ...], collect_only: bool
    ) -> None:
